                        ...
                        <div class="p-5">
                            ...
                            ?>
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <strong>Holy guacamole!</strong> <?php echo ($_SESSION['submit']) ?>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                ...
                                <form>
                                    <div class="input-group is-invalid">
                                        <div class="custom-file">
                                            ...
                                            <label class="rounded-pill custom-file-label" for="validatedInputGroupCustomFile">Upload image..</label>
                                        </div>
                                    </div>
                                    <button name="submit" class="mt-3 btn btn-primary btn-user btn-block">
                                        Register Account
                                    </button>
                                    <hr>
